...
import {SearchIcon, GlobeAltIcon, UserIcon, UserCircleIcon, MenuIcon} from '@heroicons/react/solid';
    ...
    return (
        <header className='bg-white sticky top-0 z-50 grid grid-cols-3 shadow-md p-5 md:px-10'>
            ...
            <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
                <input className='flex-grow outline-none bg-transparent pl-5 text-gray-600' type="text" placeholder='Start your search'/>
